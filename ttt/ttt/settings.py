...
INSTALLED_APPS = [
    ...
    'mptt',
    'adminsortable2',
    'trepo.apps.TrepoConfig',
#    'cachalot',                    # use cachalot for production
]
...
# memcached | use it for production:
...
# always append a slash to the url

APPEND_SLASH = True

# Site ID for sites package (required for flatpages)

SITE_ID = 1

# Limit session cookies to browser sessions

SESSION_EXPIRE_AT_BROWSER_CLOSE = True

SESSION_COOKIE_AGE = 604800

# Import and override local settings
